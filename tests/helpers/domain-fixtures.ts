  ...
  return [
    {
      ...
      semanticSlots: [{ id: "main", priority: 1, required: true, itemCapacity: 4, maxCharsPerItem: 160, acceptedRoles: ["headline", "conclusion", "fact", "metric", "process", "evidence", "visual"], bindings: { title: "component-title", body: "paragraph" }, factBearingBinding: "body", bindingExpansion: { title: 1, body: 1 } }],
      pageBindings,
      blockCapacity: 4,
    ...
    },
    {
      ...
      semanticSlots: [{ id: "main", priority: 1, required: true, itemCapacity: 2, maxCharsPerItem: 200, acceptedRoles: ["headline", "conclusion", "fact", "metric", "comparison", "evidence"], bindings: { title: "component-title", body: "paragraph" }, factBearingBinding: "body", bindingExpansion: { title: 1, body: 1 } }],
      pageBindings,
      blockCapacity: 2,
